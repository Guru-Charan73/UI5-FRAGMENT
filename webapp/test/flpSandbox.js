		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "fragment",
									"targetURL": "#fragmentapplicationfragmentcreation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fragmentapplicationfragmentcreation-display": {
								"semanticObject": "fragmentapplicationfragmentcreation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fragmentapplication.fragmentcreation",
									"url": sap.ui.require.toUrl("fragmentapplication/fragmentcreation")
								}
							}
						}
					}
